...
export const SevenDayForecast: React.FC<SevenDayForecastProps> = ({ forecast, temperatureUnit }) => {
  ...
  const getTemperature = (day: ForecastDay['day'], type: 'max' | 'min') => {
    if (temperatureUnit === 'F') {
      ...
      return temp !== undefined ? Math.round(temp) : Math.round(type === 'max' ? day.maxtemp_c * 9/5 + 32 : day.mintemp_c * 9/5 + 32);
    }
                  ...
                  <div className="bg-slate-50 dark:bg-slate-700/30 rounded-lg p-3">
                    <div className="space-y-2 text-xs">
                      ...
                      <div className="pt-1 border-t border-slate-200 dark:border-slate-600">
                        <div className="text-slate-500 dark:text-slate-400 mb-1">Condition</div>
